  ...
  return (
    <div className="min-h-screen bg-white text-black p-10">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="fixed bottom-4 right 4 z-50 uppercase text-base md:text-xl tracking-[0.2em] font-light mix-blend-difference text-white pointer-events-none px-10">
