    ...
    <div className="container mx-auto mb-20 mt-10 px-5 bg-white">
      ...
      <div className="max-w-4xl">
        ...
        <h1 className="text-sm font-mono mt-5 uppercase tracking-[0.3em] font-bold text-black">
          {data.name || "DANIELE RAINERI STUDIO"}
        </h1>
        
        {/* RICERCA (Quella che ti piace) */}
        ...
        <div className="mt-20">
          ...
          <div className="mt-5 font-mono text-[12px] text-gray-600">
            ...
            <p className="mt-2 leading-relaxed">Le nicchie gallery 2021 - Taranto</p>
          </div>
        </div>

        {/* AGGIUNTA: CONTATTI */}
        <div className="mt-24 border-t pt-10">
          <h2 className="font-mono text-[11px] uppercase tracking-widest text-gray-400 mb-4 font-normal">Contact</h2>
          <div className="font-mono text-[13px] text-black italic">
        ...
        {/* CHIUSURA */}
        <div className="mt-32">
           <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-gray-200 uppercase">Series: Intrecci</p>
        </div>
      </div>
    </div>
  );
