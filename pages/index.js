...
<>
  ...
  <div className="fixed bottom-10 right-5 md:right-10 z-50 uppercase text-base md:text-xl tracking-[0.2em] font-light mix-blend-difference text-white pointer-events-none text-right">
